...
try:
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train_loss = train_genetic_rnn(ga, train_data, 0, model, optimizer, criterion, ntokens, args.batch_size,
                                       args.bptt, args.clip,
                                       args.log_interval)

        val_loss, loss_var, max_loss, min_loss, n_diff = rnn_genetic_evaluate(ga, model, criterion, val_data, ntokens,
