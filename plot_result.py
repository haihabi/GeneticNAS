...
file_list = ["/data/projects/GNAS/logs/2019_01_10_00_01_59", "/data/projects/GNAS/logs/2019_01_10_22_59_14",
             "/data/projects/GNAS/logs/2019_01_11_08_50_49", "/data/projects/GNAS/logs/2019_01_11_15_07_07",
             "/data/projects/GNAS/logs/2019_01_11_16_43_28", "/data/projects/GNAS/logs/2019_01_12_23_37_42"]
    ...
    for i, f in enumerate(file_list):
        ...
        if data.result_dict.get('Fitness') is not None:
            ...
            if config.get('full_dataset') is None or config.get('full_dataset') == True:
                ...
                # plt.plot(epochs, np.asarray(data.result_dict.get('Training Accuracy')), label='Accuracy')
            plt.plot(epochs, np.asarray(data.result_dict.get('Best')), label=str_list[i])
        else:
